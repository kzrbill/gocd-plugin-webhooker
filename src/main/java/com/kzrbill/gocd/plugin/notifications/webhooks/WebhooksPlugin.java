...
import com.kzrbill.gocd.plugin.notifications.webhooks.executors.GetPluginConfigurationExecutor;
import com.kzrbill.gocd.plugin.notifications.webhooks.executors.GetViewRequestExecutor;
import com.kzrbill.gocd.plugin.notifications.webhooks.executors.NotificationInterestedInExecutor;
import com.kzrbill.gocd.plugin.notifications.webhooks.requests.StatusRequest;
import com.kzrbill.gocd.plugin.notifications.webhooks.requests.ValidatePluginSettings;
...
@Extension
public class WebhooksPlugin implements GoPlugin {

    public static final Logger LOG = Logger.getLoggerFor(WebhooksPlugin.class);
